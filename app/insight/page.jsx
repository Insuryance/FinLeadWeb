...
export const metadata = {
  title:
    "Indian General Insurance Premium Data · Monthly Segment Tracker | FinLead AI Insights",
  description:
  ...
  keywords: [
    "Indian general insurance premium",
    "GIC Council segment data",
    "insurer market share India",
    "motor insurance premium India",
    "health insurance premium India",
    "gross direct premium income",
    "general insurance growth India",
    "insurance segment data",
  ],
  openGraph: {
    title: "Indian General Insurance Premium Data · Monthly Segment Tracker",
    description:
      "Compare India's general insurers by premium, market share, growth and segment. Updated monthly. By FinLead AI.",
    type: "website",
  },
...
export default function InsightPage() {
  ...
  const segment = latest?.bySheet || {};
  const seg = segment["Segmentwise Report"];
  const ranked = [...seg.records].sort(
    (a, b) => (b.current["Grand Total"] || 0) - (a.current["Grand Total"] || 0),
  );
  ...
  const jsonLd = {
    ...
    "@type": "Dataset",
    name:
      "Indian General Insurance Gross Direct Premium by Segment, " +
      latest.label,
    description:
  ...
  return (
    <div className="fl-root" style={{ position: "relative", zIndex: 1 }}>
      ...
      >
        ...
        {/* header */}
        <p className="fl-eyebrow" style={{ marginTop: 28, marginBottom: 16 }}>
          FinLead AI · Insights
        </p>
        <h1
          className="fl-serif"
        ...
        >
          India's Insurance Data,{" "}
          <span className="fl-gold-grad">by the numbers.</span>
        </h1>
        ...
        >
          This page updates itself. Each month a FinLead AI agent visits the GIC
          Council, downloads the latest segment premium figures for India's
          general insurers, structures them, and publishes them here for anyone
          to use.
        </p>
        <InsightChrome />
        ...
        <div
          className="fl-glass"
          style={{ padding: "28px 26px", marginTop: 36 }}
        >
                ...
                >
                  ...
                  <td
                    style={{
                      ...
                      textAlign: "right",
                      color:
                        (r.current["Growth %"] || 0) >= 0
                          ? "#6FCF7F"
                          : "#FF7E7E",
                    }}
                  >
                    {pct(r.current["Growth %"])}
                  </td>
                  <td
                    style={{
                      padding: "10px 12px",
        ...
        <p
          className="fl-muted"
          style={{ fontSize: 12.5, marginTop: 22, lineHeight: 1.6 }}
        >
          Source: GIC Council monthly segment report. Premium figures in ₹ crore
          (gross direct premium income). Compiled and visualised by FinLead AI.
